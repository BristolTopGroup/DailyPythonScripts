...
if __name__ == '__main__':
    ...
    mu_title = title_template % ( measurement_config.new_luminosity / 1000., measurement_config.centre_of_mass_energy, 'e+jets, $\geq$ 4 jets' )
    ...
    for channel in channels:
        ...
        for var in ['M3', 'angle_bl', 'M_bl', 'absolute_eta']:
            ...
            histograms_to_draw = [histograms['data'][signalTree], histograms['QCD'][signalTree],
