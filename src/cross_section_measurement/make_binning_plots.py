...
if __name__ == '__main__':
    parser = OptionParser()
    parser.add_option( "-o", "--output_folder", dest = "output_folder", default = 'plots_binning/',
    ...
    histograms = ['GenNu_vs_RecoMET', 'GenHT_vs_RecoHT', 'GenHT_lep_met_vs_RecoHT_lep_met', 'Gen_MT_vs_Reco_MT', 'Gen_WPT_vs_Reco_WPT']
    variables_translation = {'GenNu_vs_RecoMET':'MET', 'GenHT_vs_RecoHT':'HT', 'GenHT_lep_met_vs_RecoHT_lep_met':'ST',
    						'Gen_MT_vs_Reco_MT':'MT', 'Gen_WPT_vs_Reco_WPT':'WPT'}
