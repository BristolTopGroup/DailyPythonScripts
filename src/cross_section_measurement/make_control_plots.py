...
if __name__ == '__main__':
    ...
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/Electron/electron_AbsEta'
    ...
    # histograms_to_draw = [
    #                         histograms['data'][control_region],
    #                         qcd_from_data,
    ...
    # # electron pt
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/Electron/electron_pT'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # histogram_properties.x_limits = [30, 250]
    # histogram_properties.mc_error = mc_uncertainty
    # histogram_properties.mc_errors_label = '$\mathrm{t}\\bar{\mathrm{t}}$ uncertainty'
    ...
    # # jet pt
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/Jets/all_jet_pT'
    # # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # histogram_properties = Histogram_properties()
    # histogram_properties.name = 'EPlusJets_jet_pT_' + b_tag_bin
    # if category != 'central':
    #     histogram_properties.name += '_' + category
    # histogram_properties.title = e_title + ', ' + b_tag_bins_latex[b_tag_bin]
    # histogram_properties.x_axis_title = '$p_\mathrm{T}(jet)$ [GeV]'
    # histogram_properties.y_axis_title = 'Events/(10 GeV)'
    # histogram_properties.set_log_y = True
    # histogram_properties.x_limits = [30, 500]
    # histogram_properties.mc_error = mc_uncertainty
    # histogram_properties.mc_errors_label = '$\mathrm{t}\\bar{\mathrm{t}}$ uncertainty'
    ...
    # # MET
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/MET/MET/MET'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # # MET phi
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/MET/MET/MET_phi'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # # HT
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/MET/HT'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # # ST
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/MET/MET/ST'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # # WPT
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/MET/MET/WPT'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # # MT
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/MET/MET/Transverse_Mass'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # # M(ttbar)
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/HitFit/FittedTTbarMassBestSolution'
    # qcd_control_region = control_region
    # # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    
    # histograms = get_histograms_from_files( [control_region, qcd_control_region], histogram_files )
    # if normalise_to_fit:
    #     prepare_histograms( histograms, rebin = 4, scale_factor = measurement_config.luminosity_scale, normalisation = normalisations_electron['MT'] )
    # else:
    #     prepare_histograms( histograms, rebin = 4, scale_factor = measurement_config.luminosity_scale )
    ...
    # histogram_properties = Histogram_properties()
    # histogram_properties.name = 'EPlusJets_mttbar_' + b_tag_bin
    # if category != 'central':
    #     histogram_properties.name += '_' + category
    # histogram_properties.title = e_title + ', ' + b_tag_bins_latex[b_tag_bin]
    # histogram_properties.x_axis_title = '$M_\mathrm{ttbar}$ [GeV]'
    # histogram_properties.y_axis_title = 'Events/(X GeV)'
    # histogram_properties.x_limits = [0, 1600]
    # if normalise_to_fit:
    #     histogram_properties.mc_error = get_normalisation_error( normalisations_electron['MT'] )
    #     histogram_properties.mc_errors_label = 'fit uncertainty'
    # else:
    ...
    # # Top pt
    # b_tag_bin = '2orMoreBtags'
    # control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/HitFit/FittedTopPtBestSolution'
    # qcd_control_region = control_region
    # # qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # histograms = get_histograms_from_files( [control_region, qcd_control_region], histogram_files )
    # if normalise_to_fit:
    #     prepare_histograms( histograms, rebin = 1, scale_factor = measurement_config.luminosity_scale, normalisation = normalisations_electron['MT'] )
    # else:
    #     prepare_histograms( histograms, rebin = 1, scale_factor = measurement_config.luminosity_scale )
    ...
    # histogram_properties = Histogram_properties()
    # histogram_properties.name = 'EPlusJets_topPt_' + b_tag_bin
    # if category != 'central':
    #     histogram_properties.name += '_' + category
    # histogram_properties.title = e_title + ', ' + b_tag_bins_latex[b_tag_bin]
    # histogram_properties.x_axis_title = '$p_\mathrm{t}$ [GeV]'
    # histogram_properties.y_axis_title = 'Events/(X GeV)'
    # histogram_properties.x_limits = [0, 400]
    # if normalise_to_fit:
    #     histogram_properties.mc_error = get_normalisation_error( normalisations_electron['MT'] )
    #     histogram_properties.mc_errors_label = 'fit uncertainty'
    # else:
    ...
    # W mass for JEC
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/W Bosons/hadronicWMass'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCDConversions' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    histogram_properties = Histogram_properties()
    histogram_properties.name = 'EPlusJets_WMass_' + b_tag_bin
    if category != 'central':
        histogram_properties.name += '_' + category
    histogram_properties.title = e_title + ', ' + b_tag_bins_latex[b_tag_bin]
    histogram_properties.x_axis_title = '$M_\mathrm{jj}$ [GeV]'
    histogram_properties.y_axis_title = 'Events/(5 GeV)'
    histogram_properties.x_limits = [0, 400]
    if normalise_to_fit:
        histogram_properties.mc_error = get_normalisation_error( normalisations_electron['MT'] )
    ...
    histogram_properties.name += '_with_ratio'
    make_data_mc_comparison_plot( histograms_to_draw, histogram_lables, histogram_colors,
                                 histogram_properties, save_folder = output_folder, show_ratio = True, save_as = [ 'pdf' , 'root'] )
    ...
    histogram_properties.set_log_y = True
    histogram_properties.x_limits = [1.5, 7.5]
    histogram_properties.mc_error = mc_uncertainty
    make_data_mc_comparison_plot( histograms_to_draw, histogram_lables, histogram_colors,
                                 histogram_properties, save_folder = output_folder, show_ratio = True )
    ...
    # Jet multiplicity
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/EPlusJets/Ref selection/Jets/N_Jets'
    ...
    histogram_properties.y_axis_title = 'Events'
    histogram_properties.set_log_y = True
    histogram_properties.x_limits = [3.5, 14.5]
    histogram_properties.mc_error = mc_uncertainty
    histogram_properties.mc_errors_label = '$\mathrm{t}\\bar{\mathrm{t}}$ uncertainty'
    make_data_mc_comparison_plot( histograms_to_draw, histogram_lables, histogram_colors,
                                 histogram_properties, save_folder = output_folder, show_ratio = True )
    ...
    b_tag_bin = '0btag'
    control_region = 'TTbar_plus_X_analysis/EPlusJets/QCDConversions/Electron/electron_AbsEta'
    ...
    histogram_properties.y_axis_title = 'Events/(0.1)'
    histogram_properties.x_limits = [0, 2.6]
    histogram_properties.y_limits = [0, 50]
    histogram_properties.mc_error = 0.0
    histogram_properties.mc_errors_label = 'MC unc.'
    ...
    b_tag_bin = '0btag'
    control_region = 'TTbar_plus_X_analysis/EPlusJets/QCD non iso e+jets/Electron/electron_AbsEta'
    ...
    histogram_properties.mc_error = 0.0
    make_data_mc_comparison_plot( histograms_to_draw, histogram_lables, histogram_colors,
                                 histogram_properties, save_folder = output_folder, normalise = True, show_ratio=True )
    ...
    # Muon |eta|
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/Muon/muon_AbsEta'
    ...
    # Muon pt
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/Muon/muon_pT'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # Jet pt
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/Jets/all_jet_pT'
    # qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    histogram_properties = Histogram_properties()
    histogram_properties.name = 'MuPlusJets_jet_pT_' + b_tag_bin
    if category != 'central':
        histogram_properties.name += '_' + category
    histogram_properties.title = mu_title + ', ' + b_tag_bins_latex[b_tag_bin]
    histogram_properties.x_axis_title = '$p_\mathrm{T}(jet)$ [GeV]'
    ...
    # MET
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/MET/MET/MET'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # MET phi
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/MET/MET/MET_phi'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # HT
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/MET/HT'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # ST
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/MET/MET/ST'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # WPT
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/MET/MET/WPT'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # MT
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/MET/MET/Transverse_Mass'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    # W mass for JEC
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/W Bosons/hadronicWMass'
    qcd_control_region = control_region.replace( 'Ref selection', 'QCD non iso mu+jets' )
    # qcd_control_region = control_region.replace( b_tag_bin, '0btag' )
    ...
    histogram_properties = Histogram_properties()
    histogram_properties.name = 'MuPlusJets_WMass_' + b_tag_bin
    if category != 'central':
        histogram_properties.name += '_' + category
    histogram_properties.title = mu_title + ', ' + b_tag_bins_latex[b_tag_bin]
    histogram_properties.x_axis_title = '$M_\mathrm{jj}$ [GeV]'
    ...
    # # Jet multiplicity
    b_tag_bin = '2orMoreBtags'
    control_region = 'TTbar_plus_X_analysis/MuPlusJets/Ref selection/Jets/N_Jets'
