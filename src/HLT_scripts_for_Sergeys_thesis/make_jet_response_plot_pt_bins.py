...
if __name__ == '__main__':
    ...
    histFile_uncorr = 'hists_uncorr_3rd_jet_200_250.root'
    histFile_JEC = 'hists_JEC_3rd_jet_200_250.root'
    histFile_JEC_PFnoPU = 'hists_JEC_PFnoPU_3rd_jet_200_250.root'

    histFile_30_40 = 'hists_JEC_PFnoPU_3rd_jet_30_40.root'
    histFile_40_50 = 'hists_JEC_PFnoPU_3rd_jet_40_50.root'
    histFile_50_100 = 'hists_JEC_PFnoPU_3rd_jet_50_100.root'
    histFile_100 = 'hists_JEC_PFnoPU_3rd_jet_100.root'

    suffix = 'comparison_pt_bins'
        
    input_file = File(histFile)

    input_file_uncorr = File(histFile_uncorr)
    input_file_JEC = File(histFile_JEC)
    input_file_JEC_PFnoPU = File(histFile_JEC_PFnoPU)

    input_files = {
                    'uncorrected' : input_file_uncorr,
                    'JEC' : input_file_JEC,
                    'JEC+PFnoPU' : input_file_JEC_PFnoPU
                    }
    
    input_files = {
                    '$30<p_{\mathrm{T}}<40$' : File(histFile_30_40),
                    '$40<p_{\mathrm{T}}<50$' : File(histFile_40_50),
                    '$50<p_{\mathrm{T}}<100$' : File(histFile_50_100),
                    '$p_{\mathrm{T}}>100$' : File(histFile_100)
        }
