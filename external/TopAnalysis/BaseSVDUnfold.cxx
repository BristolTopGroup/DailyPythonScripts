...
<p>
BaseSVDUnfold implements the singular value decomposition based unfolding method (see reference). Currently, the unfolding of one-dimensional histograms is supported, with the same number of bins for the measured and the unfolded spectrum.
<p>
...
<ul>
<pre>
BaseSVDUnfold *tsvdunf = new BaseSVDUnfold( bdat, Bcov, bini, xini, Adet );
...
//_______________________________________________________________________
BaseSVDUnfold::BaseSVDUnfold( const TH1D *bdat, TH2D* Bcov, const TH1D *bini, const TH1D *xini, const TH2D *Adet )
   : TObject     (),
     fNdim       (0),
     fDdim       (2),
     fNormalize  (kFALSE),
...
{
   // Default constructor
   // Initialisation of BaseSVDUnfold
...
//_______________________________________________________________________
BaseSVDUnfold::BaseSVDUnfold( const BaseSVDUnfold& other )
   : TObject     ( other ),
     fNdim       (other.fNdim),
     fDdim       (other.fDdim),
...
//_______________________________________________________________________
TH1D* BaseSVDUnfold::Unfold( Int_t kreg )
{
...
//_______________________________________________________________________
TH2D* BaseSVDUnfold::GetUnfoldCovMatrix( const TH2D* cov, Int_t ntoys, Int_t seed )
{
...
//_______________________________________________________________________
TH2D* BaseSVDUnfold::GetAdetCovMatrix( Int_t ntoys, Int_t seed )
{
...
//_______________________________________________________________________
TH1D* BaseSVDUnfold::GetSV() const 
{ 
...
//_______________________________________________________________________
TH2D* BaseSVDUnfold::GetXtau() const 
{ 
...
//_______________________________________________________________________
TH2D* BaseSVDUnfold::GetXinv() const 
{ 
...
//_______________________________________________________________________
void BaseSVDUnfold::H2V( const TH1D* histo, TVectorD& vec )
{
...
//_______________________________________________________________________
void BaseSVDUnfold::H2Verr( const TH1D* histo, TVectorD& vec )
{
...
//_______________________________________________________________________
void BaseSVDUnfold::V2H( const TVectorD& vec, TH1D& histo )
{
...
//_______________________________________________________________________
void BaseSVDUnfold::H2M( const TH2D* histo, TMatrixD& mat )
{
...
//_______________________________________________________________________
void BaseSVDUnfold::M2H( const TMatrixD& mat, TH2D& histo )
{
   // Fill 2D histogram into matrix
...
//_______________________________________________________________________
TVectorD BaseSVDUnfold::VecDiv( const TVectorD& vec1, const TVectorD& vec2, Int_t zero )
{
...
//_______________________________________________________________________
TMatrixD BaseSVDUnfold::MatDivVec( const TMatrixD& mat, const TVectorD& vec, Int_t zero )
{
...
//_______________________________________________________________________
TVectorD BaseSVDUnfold::CompProd( const TVectorD& vec1, const TVectorD& vec2 )
{
...
//_______________________________________________________________________
Double_t BaseSVDUnfold::GetCurvature(const TVectorD& vec, const TMatrixD& curv) 
{      
...
//_______________________________________________________________________
void BaseSVDUnfold::FillCurvatureMatrix( TMatrixD& tCurv, TMatrixD& tC ) const
{
...
//_______________________________________________________________________
void BaseSVDUnfold::RegularisedSymMatInvert( TMatrixDSym& mat, Double_t eps )
{
...
//_______________________________________________________________________
Double_t BaseSVDUnfold::ComputeChiSquared( const TH1D& truspec, const TH1D& unfspec)
{
