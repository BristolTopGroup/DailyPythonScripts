...
bin_edges = {
'WPT' : [0.0, 47.0, 92.0, 143.0, 206.0, 300.0],
'MET' : [0.0, 37.0, 103.0, 300.0],
'MT' : [0.0, 58.0, 100.0],
'HT' : [0.0, 200.0, 251.0, 306.0, 366.0, 433.0, 508.0, 593.0, 686.0, 795.0, 919.0, 1000.0],
'ST' : [0.0, 305.0, 367.0, 440.0, 524.0, 621.0, 732.0, 861.0, 1009.0, 1200.0],
             }
...
bin_edges_vis = {
  'WPT' : [0.0, 60.0, 121.0, 199.0, 300.0],
  'MET' : [0.0, 54.0, 179.0, 300.0],
  'MT' : [0.0, 100.0],
  'HT' : [0.0, 233.0, 296.0, 367.0, 455.0, 565.0, 703.0, 889.0, 1000.0],
  'ST' : [0.0, 351.0, 436.0, 538.0, 665.0, 830.0, 1048.0, 1200.0],
}
