...
muon_QCD_MC_file = path_to_files + 'central/QCD_MuEnrichedPt5' + middle + '.root'
...
muon_QCD_MC_category_templates = {category: path_to_files + category + '/QCD_MuEnrichedPt5' + middle + prefix + '.root' for (category, prefix) in categories_and_prefixes.iteritems()}
