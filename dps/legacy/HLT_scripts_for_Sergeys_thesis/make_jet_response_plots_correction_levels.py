...
if __name__ == '__main__':
    ...
    histFile_uncorr = 'hists_uncorr_3rd_jet_30.root'
    histFile_JEC = 'hists_JEC_3rd_jet_30.root'
    histFile_JEC_PFnoPU = 'hists_JEC_PFnoPU_3rd_jet_30.root'

    suffix = 'comparison_correction_levels'
